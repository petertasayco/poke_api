...
const Pagination = ({page, pagesLength, setPage}) => {
  ...
  return (
    <div className='pagination'>
        {
            page > 1 && <div onClick={handlePrev} className='pagination_prev pagination_active'>&#60;</div>
        }
        ...
        {
            page < pagesLength && <div onClick={handleNext} className='pagination_next pagination_active'>&#62;</div>
        }
    </div>
  )
}
